...
// ===== Composant Document =====
function ReportDocument({ report, year, logoUri }) {
  return React.createElement(Document, null,
    React.createElement(Page, { size: 'A4', style: styles.page },
      ...
      React.createElement(View, { style: styles.titleBlock },
        React.createElement(Text, { style: styles.titleMain }, 'Récapitulatif annuel'),
        React.createElement(Text, null,
          React.createElement(Text, { style: styles.titleMain }, 'de '),
          React.createElement(Text, { style: styles.titleAccent }, `revenus ${year}`)
        ),
        React.createElement(View, { style: styles.titleLine }),
        React.createElement(Text, { style: styles.subtitle },
          "Document officiel récapitulant l'ensemble des revenus encaissés via la plateforme PARTNEXX."
        )
      ),
      ...
      React.createElement(View, { style: styles.syntheseCard },
        React.createElement(View, { style: styles.syntheseHeader },
          ...
          React.createElement(View, { style: styles.periodeBadge },
            React.createElement(Text, { style: styles.periodeText }, `PÉRIODE ${year}`)
          )
        ),
      ...
      React.createElement(View, { style: styles.bottomGrid },
        ...
        React.createElement(View, { style: styles.bottomCard },
          ...
          React.createElement(Text, { style: styles.legalPara },
            "Ce récapitulatif est émis conformément à l'article 242 bis du Code général des impôts. Il atteste des sommes brutes encaissées par votre intermédiaire sur la plateforme PARTNEXX au titre de l'année indiquée."
          ),
          React.createElement(Text, { style: styles.legalPara },
...
export async function GET(req) {
  try {
    ...
    // 4. Données
    const { data: report, error: rpcErr } = await supabaseAdmin.rpc('get_creator_annual_report', {
    ...
    const pdfBuffer = await renderToBuffer(
      React.createElement(ReportDocument, { report, year, logoUri: logoUri || null })
    )
