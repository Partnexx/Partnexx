...
export default function CollaborationsSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'CollaborationsSection'.replace('Section', '')
  return (
