...
export default function FeedbackSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'FeedbackSection'.replace('Section', '')
  return (
