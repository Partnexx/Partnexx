...
export default function MessagerieSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'MessagerieSection'.replace('Section', '')
  return (
