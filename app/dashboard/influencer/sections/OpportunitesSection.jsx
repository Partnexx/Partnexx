...
export default function OpportunitesSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'OpportunitesSection'.replace('Section', '')
  return (
