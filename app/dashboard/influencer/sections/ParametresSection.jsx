...
export default function ParametresSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'ParametresSection'.replace('Section', '')
  return (
