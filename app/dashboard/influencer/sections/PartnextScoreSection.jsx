...
export default function PartnextScoreSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'PartnextScoreSection'.replace('Section', '')
  return (
