...
import {
  ...
  Brain, Eye, Users, Calendar, BarChart3, Zap, Lock
} from 'lucide-react'
...
/* ============================================================
   SVG inline pour les icônes absentes de lucide-react@1.16.0
   ============================================================ */
...
/* ============================================================
   Métadonnées visuelles des niveaux
   ============================================================ */
const LEVEL_VISUALS = {
  bronze: { gradient: 'from-orange-400 to-amber-600', bgGradient: 'from-orange-50 to-amber-100', borderColor: 'border-orange-300', textColor: 'text-orange-700', tagline: 'Débloque tes premières opportunités',
    perks: [{ icon: '🎯', label: 'Défis quotidiens débloqués' }, { icon: '✅', label: 'Profil créateur vérifié' }, { icon: '📊', label: 'Dashboard débloqué' }, { icon: '💸', label: 'Flux financiers : retraits activés' }] },
  argent: { gradient: 'from-slate-400 to-slate-600', bgGradient: 'from-slate-50 to-slate-100', borderColor: 'border-slate-300', textColor: 'text-slate-700', tagline: 'Progression créateur accélérée',
    perks: [{ icon: '✅', label: 'Défis hebdomadaires débloqués' }, { icon: '📊', label: 'Statistiques avancées' }, { icon: '🎨', label: 'Thèmes de profil exclusifs' }, { icon: '🎯', label: 'Multiplicateur Partnexx Score x1,5' }] },
  or: { gradient: 'from-yellow-400 to-amber-500', bgGradient: 'from-yellow-50 to-amber-100', borderColor: 'border-yellow-400', textColor: 'text-yellow-700', tagline: 'Développe ton activité créateur',
    perks: [{ icon: '✅', label: 'Défis mensuels débloqués' }, { icon: '📊', label: 'Analytics créateurs complets' }, { icon: '🎨', label: 'Personnalisation avancée du profil' }, { icon: '🎯', label: 'Suivi détaillé des performances collaborations' }] },
  platine: { gradient: 'from-cyan-400 to-sky-500', bgGradient: 'from-cyan-50 to-sky-100', borderColor: 'border-cyan-400', textColor: 'text-cyan-700', tagline: 'Débloque les avantages premium',
    perks: [{ icon: '🛍️', label: 'Marketplace débloquée' }, { icon: '🤖', label: 'Accès aux IA Partnexx' }, { icon: '📈', label: 'Historique revenus avancé' }, { icon: '🎧', label: 'Support prioritaire' }] },
  diamant: { gradient: 'from-teal-400 to-cyan-500', bgGradient: 'from-teal-50 to-cyan-100', borderColor: 'border-teal-400', textColor: 'text-teal-700', tagline: 'Accès créateur avancé',
    perks: [{ icon: '✨', label: 'Opportunités exclusives débloquées' }, { icon: '🛍️', label: 'Marketplace Premium débloquée' }, { icon: '🚀', label: 'Accès anticipé aux nouveautés Partnexx' }, { icon: '💎', label: 'Récompenses créateur augmentées sur les invitations de marques' }] },
  elite: { gradient: 'from-fuchsia-500 to-pink-500', bgGradient: 'from-fuchsia-50 to-pink-100', borderColor: 'border-fuchsia-400', textColor: 'text-fuchsia-700', tagline: 'Cercle premium Partnexx',
    perks: [{ icon: '🤝', label: 'Collaborations premium négociées' }, { icon: '📣', label: 'Mise en avant sur le LinkedIn de Partnexx' }, { icon: '💼', label: 'Campagnes confidentielles' }, { icon: '👑', label: 'Accès complet à l\'écosystème PARTNEXX' }] },
  champion: { gradient: 'from-violet-500 to-purple-600', bgGradient: 'from-violet-50 to-purple-100', borderColor: 'border-violet-400', textColor: 'text-violet-700', tagline: 'Niveau créateur reconnu',
    perks: [{ icon: '🌟', label: 'Mise en avant sur le Instagram de PARTNEXX' }, { icon: '🤝', label: 'Opportunités premium débloquées' }, { icon: '🎁', label: 'Partnexx Score X2' }, { icon: '💎', label: 'Avantages marketplace' }] },
  legende: { gradient: 'from-pink-500 via-orange-500 to-yellow-500', bgGradient: 'from-pink-50 via-orange-50 to-yellow-100', borderColor: 'border-pink-400', textColor: 'text-pink-700', tagline: 'Niveau maximum Partnexx',
    perks: [{ icon: '💰', label: 'Frais Partnexx réduits de 2%' }, { icon: '🏆', label: 'Statut "Top Créateur"' }, { icon: '✉️', label: 'Invitations privées Partnexx' }, { icon: '🧠', label: 'Conseiller stratégique dédié' }] },
}

/* ============================================================
   Données défis / achievements / marketplace
   ============================================================ */
...
const weeklyChallenges = [
  { id: 10, title: "Empereur des Conversions", description: "Maintenir 90%+ de taux de conversion sur 7 jours", reward: "+150 pts + Accès VIP Premium", timeLeft: "4j 12h", progress: 71, difficulty: "Epic", icon: Crown, color: "from-purple-500 to-indigo-600", participants: 312, completions: 45, streak: 3 },
...
const monthlyChallenges = [
  { id: 20, title: "Légende de Partnexx", description: "Dominer le classement pendant 30 jours", reward: "+500 pts + Statut Légende + Revenue Share", timeLeft: "18j 7h", progress: 45, difficulty: "Légendaire", icon: Trophy, color: "from-yellow-400 via-orange-500 to-red-600", participants: 50, completions: 2, exclusive: true },
  { id: 21, title: "Empire Builder", description: "Générer 50k€+ de revenus via la plateforme", reward: "+300 pts + Consultant Dédié + Événement Exclusif", timeLeft: "18j 7h", progress: 72, difficulty: "Epic", icon: Briefcase, color: "from-indigo-500 to-purple-600", participants: 128, completions: 12 },
  { id: 22, title: "Mentor Suprême", description: "Former et accompagner 5 nouveaux créateurs au succès", reward: "+250 pts + Programme Ambassador + Equity", timeLeft: "18j 7h", progress: 20, difficulty: "Epic", icon: BookOpen, color: "from-green-500 to-teal-600", participants: 89, completions: 8 },
]
const achievements = [
...
// Items standards de la marketplace (visibles dès Platine)
...
// Items premium (visibles uniquement à partir de Diamant)
const premiumPerks = [
...
export default function PartnextScoreSection({ user }) {
  ...
  useEffect(() => {
    if (selectedChallenge === 'monthly' && !canDoMonthlyChallenges) {
      setSelectedChallenge(canDoWeeklyChallenges ? 'weekly' : 'daily')
    } else if (selectedChallenge === 'weekly' && !canDoWeeklyChallenges) {
      setSelectedChallenge('daily')
    }
  }, [selectedChallenge, canDoWeeklyChallenges, canDoMonthlyChallenges])

  // ===== LOCKS sur l'onglet Marketplace =====
  const canAccessMarketplace = canAccess('marketplace')         // Platine+
  const canAccessPremiumMarketplace = canAccess('premiumMarketplace') // Diamant+
  const marketplaceRequiredLevel = getRequiredLevel('marketplace') // → Platine
  const marketplaceProgress = marketplaceRequiredLevel
    ? Math.min((score / marketplaceRequiredLevel.threshold) * 100, 100)
    : 0
  const pointsToMarketplace = marketplaceRequiredLevel
    ? Math.max(0, marketplaceRequiredLevel.threshold - score)
    : 0
  ...
  const leaderboardWithUser = userInTop7 ? top7 : [
    ...top7,
    { rank: top7.length + 1, name: 'Vous', score, avatar: '🏆', trend: '+' + liveUpdates, badge: '🎖️', isUser: true }
  ]
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width=%2260%22%20height=%2260%22%20viewBox=%220%200%2060%2060%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg%20fill=%22none%22%20fill-rule=%22evenodd%22%3E%3Cg%20fill=%22%23a855f7%22%20fill-opacity=%220.05%22%3E%3Cpath%20d=%22M30%2030c0-11.046-8.954-20-20-20S-10%2018.954-10%2030s8.954%2020%2020%2020%2020-8.954%2020-20zM30%2030c0-11.046%208.954-20%2020-20s20%208.954%2020%2020-8.954%2020-20%2020-20-8.954-20-20z%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-30" />
      ...
      <div className="relative z-10 space-y-8 p-6">
        ...
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-6xl font-black bg-gradient-to-r from-primary via-purple-500 via-pink-500 to-orange-500 bg-clip-text text-transparent drop-shadow-2xl">
                Partnexx Empire
              </h1>
              <p className="text-xl text-muted-foreground mt-2">
                🚀 <span className="font-bold text-primary">Niveau {level?.name || 'Verrouillé'}</span> • Rang #{userRank} • +{liveUpdates} pts temps réel
              </p>
            </div>
          </div>
        </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-6xl">
                    ...
                    <CardContent className="p-8 relative z-10">
                      <div className="text-center space-y-6">
                        <div className="relative inline-block">
                          <div className="text-9xl font-black bg-gradient-to-r from-primary via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-2xl animate-pulse">
                        ...
                        <Badge className={`text-xl px-6 py-3 ${level ? `bg-gradient-to-r ${LEVEL_VISUALS[level.key].gradient}` : 'bg-gradient-to-r from-gray-400 to-gray-600'} text-white border-0 shadow-lg`}>
                          {level ? `${level.emoji} ${level.name} Créateur • Rang #${userRank}` : '🔒 Profil incomplet'}
                        </Badge>

                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                          <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-500/30">
                            <div className="text-2xl font-bold text-green-600">94.2%</div>
                            <div className="text-sm text-green-600/80">Efficacité</div>
                          </div>
                          <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl p-4 border border-blue-500/30">
                            <div className="text-2xl font-bold text-blue-600">78.5%</div>
                            <div className="text-sm text-blue-600/80">Influence</div>
                          </div>
                          <div className="bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-xl p-4 border border-purple-500/30">
                            ...
                            <div className="text-sm text-purple-600/80">IA Boost</div>
                          </div>
                          <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-xl p-4 border border-orange-500/30">
                            <div className="text-2xl font-bold text-orange-600">92.1%</div>
                            <div className="text-sm text-orange-600/80">Impact</div>
                          </div>
                        </div>
                          ...
                          {!isProfileComplete && !levelLoading && (
                            <div className="bg-gradient-to-r from-orange-500/10 to-amber-500/10 border border-orange-500/30 rounded-2xl p-6 space-y-4">
                              <div className="flex items-center justify-center gap-3">
                                ...
                                <h3 className="text-xl font-bold text-orange-700">Complète ton profil pour débloquer Bronze</h3>
                              </div>
                              ...
                              <Button onClick={() => router.push('/dashboard/influencer?section=profil')} className="w-full bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold">
                            ...
                            <div className="flex justify-between items-center mb-6">
                              ...
                              {nextLevel && level && (
                                <span className="text-sm text-muted-foreground">
                                  <span className="font-bold text-primary">{pointsToNextLevel} pts</span> vers <span className="font-semibold">{nextLevel.name}</span>
                                </span>
                              )}
                            </div>
                                  ...
                                  return (
                                    <button key={lvl.key} onClick={() => setSelectedLevelKey(lvl.key)} className="flex flex-col items-center group cursor-pointer">
                                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center text-2xl transition-all duration-300 relative z-10 ${isUnlocked ? `bg-gradient-to-br ${visual.gradient} shadow-lg group-hover:scale-110` : 'bg-muted text-muted-foreground grayscale opacity-60 group-hover:opacity-80'} ${isCurrent ? 'ring-4 ring-primary ring-offset-2 ring-offset-background animate-pulse scale-110' : ''} ${isSelected && !isCurrent ? 'ring-2 ring-primary/50 ring-offset-2 ring-offset-background' : ''}`}>
                                        {isUnlocked ? lvl.emoji : <Lock className="h-5 w-5" />}
                                      </div>
                            ...
                            <CardContent className="p-6 space-y-5">
                              <div className="flex items-start justify-between">
                                <div className="flex items-center gap-4">
                                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${selectedVisual.gradient} flex items-center justify-center text-3xl shadow-lg ${!isSelectedLevelUnlocked && 'grayscale opacity-70'}`}>
                                    {isSelectedLevelUnlocked ? selectedLevel.emoji : <Lock className="h-7 w-7 text-white" />}
                                  </div>
                                  <div>
                                    <div className="text-xs font-bold text-muted-foreground tracking-wider">NIVEAU</div>
                                    <div className={`text-2xl font-black ${selectedVisual.textColor}`}>{selectedLevel.name}</div>
                                  </div>
                                </div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {selectedVisual.perks.map((perk, i) => (
                                  <div key={i} className="bg-white/80 backdrop-blur-sm rounded-xl p-3 flex items-center gap-3 shadow-sm">
                              ...
                              <div className="flex justify-start">
                                <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${selectedVisual.gradient} ${!isSelectedLevelUnlocked && 'grayscale opacity-70'}`}>
                                  <BarChart3 className="h-4 w-4 text-white" />
                                  <span className="text-sm font-bold text-white">{selectedVisual.tagline}</span>
                                </div>
                              </div>

                              {!isSelectedLevelUnlocked && (
                                <div className="bg-muted/50 rounded-lg p-3 text-center text-sm">
                                  🔒 <span className="font-semibold">{Math.max(0, selectedLevel.threshold - score)} points</span> requis pour débloquer ce niveau
                                </div>
                              )}
                            </CardContent>
                          </Card>
                ...
                <div className="space-y-6">
                  <Card className="bg-gradient-to-br from-card to-primary/5 border-primary/20 shadow-xl">
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex justify-between items-center"><span className="text-sm">Croissance 7j</span><span className="text-lg font-bold text-green-600">+15.8%</span></div>
                      ...
                      <div className="flex justify-between items-center"><span className="text-sm">Prédiction IA</span><span className="text-lg font-bold text-purple-600">1150 pts</span></div>
                      <Separator />
                      <div className="text-center p-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg">
                        ...
                        <div className="text-sm font-semibold">En temps réel • +{liveUpdates} pts</div>
                      </div>
                    </CardContent>
                  </Card>
                </div>
              ...
              {!isProfileComplete && !levelLoading && (
                <Card className="bg-gradient-to-br from-orange-500/10 to-amber-500/10 border-orange-500/30">
                  <CardContent className="p-12 text-center space-y-6">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-orange-700 mb-2">Défis verrouillés</h2>
                      <p className="text-muted-foreground">Complète ton profil à 100% pour accéder aux défis Partnexx et commencer à gagner des points.</p>
                    </div>
              ...
              {isProfileComplete && (
                <>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-semibold">
                              Débloque les défis {!canDoWeeklyChallenges ? 'hebdomadaires' : 'mensuels'} en passant <span className="text-primary">{nextLevel.name}</span>
                            </p>
                            <p className="text-xs text-muted-foreground">Plus que {pointsToNextLevel} points</p>
                          </div>
                        </div>
                  ...
                  {selectedChallenge === 'daily' && canDoDailyChallenges && (
                    <div className="grid gap-6">
                      <div className="text-center mb-6">
                        <h2 className="text-3xl font-bold bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent">Défis Quotidiens 🌅</h2>
                        <p className="text-muted-foreground mt-2">Rechargés chaque jour à minuit</p>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {dailyChallenges.map((c) => {
                          const Icon = c.icon
                          const accepted = acceptedChallenges.has(c.id)
                          return (
                            <Card key={c.id} className="group relative overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
                              <div className={`absolute inset-0 bg-gradient-to-r ${c.color} opacity-5`} />
                              <CardHeader className="relative z-10">
                                <div className="flex items-center justify-between mb-4">
                                  <div className={`p-3 rounded-xl bg-gradient-to-r ${c.color} shadow-lg`}><Icon className="h-6 w-6 text-white" /></div>
                                  <Badge variant={c.difficulty === 'Facile' ? 'secondary' : c.difficulty === 'Moyen' ? 'default' : 'destructive'}>{c.difficulty}</Badge>
                                </div>
                                <CardTitle className="text-xl">{c.title}</CardTitle>
                              </CardHeader>
                              <CardContent className="relative z-10 space-y-6">
                                <p className="text-muted-foreground">{c.description}</p>
                                {accepted && <div className="space-y-2"><div className="flex justify-between text-sm"><span>Progression</span><span>{c.progress}%</span></div><Progress value={c.progress} className="h-2" /></div>}
                                <div className="bg-primary/10 rounded-lg p-3 border border-primary/20">
                                  <div className="flex items-center gap-2"><Gift className="h-4 w-4 text-primary" /><span className="text-sm font-medium text-primary">{c.reward}</span></div>
                                </div>
                                <Button onClick={() => handleAcceptChallenge(c.id)} disabled={accepted} className={`w-full ${accepted ? 'bg-green-600' : 'bg-gradient-to-r from-green-500 to-emerald-500'} text-white font-bold`}>
                  ...
                  {selectedChallenge === 'weekly' && canDoWeeklyChallenges && (
                    <div className="grid gap-6">
                      <div className="text-center mb-6">
                        <h2 className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Défis Hebdomadaires 🔥</h2>
                      </div>
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {weeklyChallenges.map((c) => {
                          ...
                          return (
                            <Card key={c.id} className="group relative overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
                              <div className={`absolute inset-0 bg-gradient-to-r ${c.color} opacity-5`} />
                              {c.streak && <div className="absolute top-4 right-4 bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs px-2 py-1 rounded-full font-bold z-20">🔥 Série {c.streak}</div>}
                              <CardHeader className="relative z-10">
                                <div className="flex items-center justify-between mb-4">
                                  <div className={`p-4 rounded-xl bg-gradient-to-r ${c.color} shadow-xl`}><Icon className="h-8 w-8 text-white" /></div>
                                  <Badge variant={c.difficulty === 'Epic' ? 'destructive' : 'default'} className="text-sm">{c.difficulty}</Badge>
                                </div>
                                <CardTitle className="text-xl">{c.title}</CardTitle>
                              </CardHeader>
                              <CardContent className="relative z-10 space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg p-4 border border-primary/20">
                                  <div className="flex items-center gap-2"><Crown className="h-5 w-5 text-primary" /><span className="text-sm font-bold text-primary">{c.reward}</span></div>
                                </div>
                                <Button onClick={() => handleAcceptChallenge(c.id)} disabled={accepted} className={`w-full ${accepted ? 'bg-orange-600' : `bg-gradient-to-r ${c.color}`} text-white font-bold py-3`}>
                                  {accepted ? <><Target className="h-5 w-5 mr-2" />En cours...</> : <><Rocket className="h-5 w-5 mr-2" />Conquérir le Défi</>}
                                </Button>
                              </CardContent>
                            </Card>
                          )
                  ...
                  {selectedChallenge === 'monthly' && canDoMonthlyChallenges && (
                    <div className="grid gap-6">
                      <div className="text-center mb-6">
                        <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent">Défis Légendaires 👑</h2>
                      </div>
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {monthlyChallenges.map((c) => {
                          ...
                          const accepted = acceptedChallenges.has(c.id)
                          return (
                            <Card key={c.id} className={`group relative overflow-hidden hover:shadow-2xl transition-all hover:scale-105 ${c.exclusive ? 'ring-2 ring-yellow-500/50' : ''}`}>
                              <div className={`absolute inset-0 bg-gradient-to-r ${c.color} opacity-10`} />
                              <CardHeader className="relative z-10">
                                <div className="flex items-center justify-between mb-4">
                                  <div className={`p-4 rounded-xl bg-gradient-to-r ${c.color} shadow-xl`}><Icon className="h-8 w-8 text-white" /></div>
                                  <Badge variant="destructive" className={`${c.difficulty === 'Légendaire' ? 'bg-gradient-to-r from-yellow-500 to-orange-500' : ''} text-sm font-bold`}>{c.difficulty}</Badge>
                                </div>
                                <CardTitle className="text-xl">{c.title}</CardTitle>
                              </CardHeader>
                              <CardContent className="relative z-10 space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-lg p-4 border border-yellow-500/30">
                                  <div className="flex items-center gap-2"><Diamond className="h-5 w-5 text-yellow-600" /><span className="text-sm font-bold text-yellow-700">{c.reward}</span></div>
                                </div>
                                <Button onClick={() => handleAcceptChallenge(c.id)} disabled={accepted} className={`w-full ${accepted ? 'bg-purple-600' : `bg-gradient-to-r ${c.color}`} text-white font-black py-4 text-lg`}>
                                  {accepted ? <><Target className="h-6 w-6 mr-2" />En cours...</> : <><Crown className="h-6 w-6 mr-2" />Devenir Légende</>}
                                </Button>
                              </CardContent>
                            </Card>
                          )
            ...
            <TabsContent value="leaderboard" className="space-y-8 mt-8">
              <Card className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border-yellow-500/30">
                <CardHeader>
                  <CardTitle className="flex items-center gap-3 text-2xl"><Trophy className="h-8 w-8 text-yellow-600" />Classement Global Elite</CardTitle>
                  <p className="text-muted-foreground">🏆 Les légendes de Partnexx • Mis à jour en temps réel</p>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={u.rank} className={`flex items-center gap-6 p-4 rounded-xl border transition-all hover:scale-105 ${u.isUser ? 'border-primary bg-gradient-to-r from-primary/10 to-purple-500/10' : 'border-muted/30 bg-card/80 hover:bg-card'}`}>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-1">
                            ...
                            {u.isUser && <Badge className="bg-gradient-to-r from-primary to-purple-500 text-white animate-pulse">VOUS</Badge>}
                          </div>
                          <div className="flex items-center gap-4">
                            <span className="text-xl font-bold text-primary">{(u.score || 0).toLocaleString()} pts</span>
                            <span className="text-sm text-green-600 font-medium">{u.trend} cette semaine</span>
                          </div>
                        </div>
                      </div>
                    ))}
                        ...
                        <Card key={i} className={`relative overflow-hidden transition-all hover:scale-105 ${a.unlocked ? 'border-2 shadow-xl' : 'border-muted/30 opacity-60 grayscale'}`}>
                          <CardContent className="p-6 text-center space-y-4">
                            ...
                            <div>
                              ...
                              <Badge variant="outline" className={`${a.unlocked ? `bg-gradient-to-r ${color} text-white border-0` : 'opacity-50'} font-bold text-xs`}>{a.rarity.toUpperCase()}</Badge>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div className="flex-1 space-y-3">
                                ...
                                <div className="flex items-center gap-2">
                                  <div className="flex-1 bg-secondary/20 rounded-full h-2"><div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-2 rounded-full" style={{ width: `${insight.confidence}%` }} /></div>
                                  <span className="text-sm font-medium text-cyan-600">{insight.confidence}%</span>
                                </div>
                              </div>
                            </div>
                          </CardContent>
            ...
            <TabsContent value="marketplace" className="space-y-8 mt-8">
              ...
              {!isProfileComplete && !levelLoading && (
                <Card className="bg-gradient-to-br from-orange-500/10 to-amber-500/10 border-orange-500/30">
                  <CardContent className="p-12 text-center space-y-6">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-orange-700 mb-2">Marketplace verrouillée</h2>
                      <p className="text-muted-foreground">Commence par compléter ton profil à 100% pour démarrer ton ascension Partnexx.</p>
                    </div>
              ...
              {/* CAS 2 : Profil OK mais niveau insuffisant (< Platine) */}
              {isProfileComplete && !canAccessMarketplace && (
                <Card className="bg-gradient-to-br from-cyan-500/10 to-sky-500/10 border-cyan-500/30">
                  <CardContent className="p-12 text-center space-y-6">
                    <div className="relative inline-block">
                      <div className="w-24 h-24 mx-auto rounded-3xl bg-gradient-to-br from-cyan-400 to-sky-500 flex items-center justify-center shadow-2xl">
                        <ShoppingBag className="h-12 w-12 text-white" />
                      </div>
                      <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-card rounded-full flex items-center justify-center shadow-lg border-2 border-cyan-400">
                        <Lock className="h-5 w-5 text-cyan-600" />
                      </div>
                    </div>

                    <div>
                      <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-500 to-sky-500 bg-clip-text text-transparent mb-2">
                        Marketplace verrouillée
                      </h2>
                      <p className="text-muted-foreground max-w-md mx-auto">
                        La Marketplace exclusive Partnexx te permet d&apos;échanger tes points contre des avantages premium : consultations IA, accès beta, mentor personnel, events privés...
                      </p>
                    </div>

                    {/* Niveau requis */}
                    <div className="inline-flex items-center gap-3 bg-card rounded-2xl px-6 py-4 border-2 border-cyan-300 shadow-lg">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-400 to-sky-500 flex items-center justify-center text-2xl">
                        💠
                      </div>
                      <div className="text-left">
                        <div className="text-xs text-muted-foreground font-semibold">DÉBLOQUER À</div>
                        <div className="text-xl font-black text-cyan-700">Niveau Platine</div>
                        <div className="text-xs text-muted-foreground">{marketplaceRequiredLevel?.threshold.toLocaleString()} pts requis</div>
                      </div>
                    </div>
                    ...
                    <div className="max-w-md mx-auto space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-bold text-cyan-600">{score.toLocaleString()} / {marketplaceRequiredLevel?.threshold.toLocaleString()} pts</span>
                      </div>
                      <div className="relative h-4 bg-cyan-500/10 rounded-full overflow-hidden">
                        <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-cyan-400 to-sky-500 rounded-full transition-all duration-1000" style={{ width: `${marketplaceProgress}%` }} />
                      </div>
                      <p className="text-sm text-muted-foreground">
                        Plus que <span className="font-bold text-cyan-600">{pointsToMarketplace.toLocaleString()} points</span> pour débloquer la Marketplace
                      </p>
                    </div>
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-cyan-500 to-sky-500 hover:from-cyan-600 hover:to-sky-600 text-white font-bold"
                    >
                      <Gamepad2 className="h-4 w-4 mr-2" />
                      Faire des défis pour gagner des points
                    </Button>
                  </CardContent>
                </Card>
              )}

              {/* CAS 3 : Marketplace débloquée (Platine+) */}
              {isProfileComplete && canAccessMarketplace && (
                <>
                  {/* Bandeau "Marketplace Premium débloquée" si Diamant+ */}
                  {canAccessPremiumMarketplace && (
                    <Card className="bg-gradient-to-r from-teal-500/10 via-cyan-500/10 to-pink-500/10 border-teal-400/40">
                      <CardContent className="p-4 flex items-center justify-center gap-3 flex-wrap">
                        <Flame className="h-6 w-6 text-teal-600 animate-pulse" />
                        <span className="font-bold bg-gradient-to-r from-teal-600 to-pink-600 bg-clip-text text-transparent text-lg">
                          Marketplace Premium débloquée
                        </span>
                  ...
                  <Card className="bg-gradient-to-br from-pink-500/10 to-purple-500/10 border-pink-500/30">
                    <CardHeader>
                      <CardTitle className="flex items-center gap-3 text-2xl">
                        <Gift className="h-8 w-8 text-pink-600" />Marketplace Exclusif
                      </CardTitle>
                      <p className="text-muted-foreground">💎 Vous avez {score.toLocaleString()} points à dépenser</p>
                    </CardHeader>
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Items standards (visibles à partir de Platine) */}
                            ...
                            <Card key={i} className="hover:shadow-xl transition-all hover:scale-105">
                              <CardContent className="p-6">
                                <div className="flex items-start gap-4 mb-4">
                                  ...
                                  <div className="flex-1"><h4 className="font-bold text-lg mb-2">{p.title}</h4><p className="text-muted-foreground text-sm">{p.description}</p></div>
                                </div>
                                <div className="flex items-center justify-between mb-3">
                                  <div className="flex items-center gap-2"><Coins className="h-5 w-5 text-primary" /><span className={`text-xl font-bold ${canAfford ? 'text-primary' : 'text-red-500'}`}>{p.cost} points</span></div>
                                  <Badge variant="secondary">{p.popularity}% populaire</Badge>
                                </div>
                        ...
                        {/* Items PREMIUM (uniquement Diamant+) */}
                        {canAccessPremiumMarketplace && premiumPerks.map((p, i) => {
                          ...
                          return (
                            <Card key={`premium-${i}`} className="hover:shadow-xl transition-all hover:scale-105 border-2 border-teal-400/50 bg-gradient-to-br from-teal-50/50 to-cyan-50/50">
                              <CardContent className="p-6">
                                <div className="flex items-start gap-4 mb-4">
                                  <div className="bg-gradient-to-r from-teal-500 to-cyan-500 p-3 rounded-xl shadow-lg"><Icon className="h-6 w-6 text-white" /></div>
                                  <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                      <h4 className="font-bold text-lg">{p.title}</h4>
                                      <Badge className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white border-0 text-[10px]">PREMIUM</Badge>
                                    </div>
                                    <p className="text-muted-foreground text-sm">{p.description}</p>
                                  </div>
                                </div>
                                <div className="flex items-center justify-between mb-3">
                                  <div className="flex items-center gap-2"><Coins className="h-5 w-5 text-teal-600" /><span className={`text-xl font-bold ${canAfford ? 'text-teal-600' : 'text-red-500'}`}>{p.cost} points</span></div>
                                  <Badge variant="secondary">{p.popularity}% populaire</Badge>
                                </div>
                                {!canAfford && <p className="text-xs text-red-500 mb-2">Il vous manque {p.cost - score} points</p>}
                                <Button className={`w-full font-bold ${canAfford ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white' : 'bg-muted text-muted-foreground'}`} disabled={!canAfford} onClick={() => toast.success(`${p.title} échangé ! 🔥`)}>
                                  {canAfford ? <><Gem className="h-4 w-4 mr-2" />Échanger</> : <><Clock className="h-4 w-4 mr-2" />Points insuffisants</>}
                                </Button>
                              </CardContent>
                            </Card>
                          )
                      ...
                      <div className="text-center p-6 bg-gradient-to-r from-primary/10 to-purple-500/10 rounded-2xl border border-primary/20">
                        ...
                        <p className="text-muted-foreground mt-2">Gagnez plus de points en complétant des défis</p>
                      </div>
                    </CardContent>
                  </Card>
                </>
