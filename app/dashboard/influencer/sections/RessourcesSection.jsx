...
export default function RessourcesSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'RessourcesSection'.replace('Section', '')
  return (
