...
export default function StatistiquesSection({ profile, metrics, collaborations, transactions, contracts, notifications }) {
  const title = 'StatistiquesSection'.replace('Section', '')
  return (
